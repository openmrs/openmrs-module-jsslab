...
public class LabCatalogServiceTest extends BaseModuleContextSensitiveTest {
	...
	public void getLabPreconditionByUuid_shouldGetByUuid() throws Exception {
		...
		Assert.assertEquals("getLabPreconditionByUuid should return the right object",
		    "0100dc0a-46da-11e1-99f4-0024e8c61285", labPrecondition.getUuid());
	}
	...
	/**
	 * @see LabCatalogService#getLabPreconditions(String displayFragment, Boolean ifVoided, Integer
	...
	public void voidLabPrecondition_shouldVoidedLabPrecondition() throws Exception {
		...
		Assert.assertEquals("voidLabPrecondition should return the right object with voided true", "true", labPrecondition
		        .getVoided().toString());
	}
	...
	public void getLabSpecimenTemplateByUuid_shouldGetByUuid() throws Exception {
		LabSpecimenTemplate labSpecimenTemplate = Context.getService(LabCatalogService.class).getLabSpecimenTemplateByUuid(
		...
		Assert.assertEquals("getLabSpecimenTemplateByUuid should return the right object",
		    "35442792-49b7-11e1-812a-0024e8c61285", labSpecimenTemplate.getUuid());
	}
	...
	public void saveLabSpecimenTemplate_shouldSaveRecord() throws Exception {
		...
		Assert.assertEquals("getLabPreconditionByUuid should return the right object", "12312312-1231-1231-1231-123123123",
	...
	/**
	 * @see LabCatalogService#getLabSpecimenTemplate(String displayFragment, Boolean ifVoided,
	...
	public void retireLabSpecimenTemplate_shouldRetireLabSpecimenTemplate() throws Exception {
		...
		Assert.assertEquals("retireLabSpecimenTemplate should return the right object with voided true", "true",
	...
	public void getLabSpecimenTemplate_shouldGetLabSpecimenTemplate() throws Exception {
		LabSpecimenTemplate labSpecimenTemplate = Context.getService(LabCatalogService.class).getLabSpecimenTemplate(
		    33333001);
		Assert.assertNotNull("getLabSpecimenTemplate should not return null", labSpecimenTemplate);
		Assert.assertEquals("getLabSpecimenTemplate should return the right object", "35442792-49b7-11e1-812a-0024e8c61285",
		    labSpecimenTemplate.getUuid());
	}
	...
	public void retireLabTest_shouldRetireLabTest() throws Exception {
		...
		Assert.assertEquals("retireLabTest should return the right object with voided true", Boolean.TRUE,
		    labTest.getRetired());
		Assert.assertEquals("retireLabTest should return the right object with retire reason", "testing retire",
		    labTest.getRetireReason());
	...
	@Test
	public void saveLabTest_shouldNotSaveLabTestIfLabTestDoesntValidate() throws Exception {
	...
	public void getAllLabTests_shouldGetAllLabTestByIfIncludeRetired() throws Exception {
		LabTest labTest = Context.getService(LabCatalogService.class).getLabTestByUUID(
		    "5d1545bb-486e-11e1-b5ed-0024e8c61285");
		Context.getService(LabCatalogService.class).retireLabTest(labTest, "testing retire");
	...
	public void retireLabTestPanel_shouldRetireLabTestPanel() throws Exception {
		LabTestPanel labTestPanel = Context.getService(LabCatalogService.class).getLabTestPanelByUuid(
		...
		LabTestPanel labTestPanelFromDB = Context.getService(LabCatalogService.class).getLabTestPanelByUuid(
	...
	public void getLabTestPanels_shouldReturnLabTestPanelByStringNameFragmentBooleanIncludeVoidedIntegerStartIntegerLength()
		...
		Assert.assertEquals("getLabTestPanels should return the right object when using name fragment",
		...
		Assert.assertEquals("getLabTestPanels should return the right object", "05dec1ac-46d9-11e1-99f4-0024e8c61285", list
		        .get(0).getUuid());
		Assert.assertEquals("getLabTestPanels should return the right object", "05df00e1-46d9-11e1-99f4-0024e8c61285", list
		        .get(1).getUuid());
	}
	...
	@Test
	public void purgeLabTestPanel_shouldDeleteGivenLabTestPanel() throws Exception {
		String uuid = "05df00e1-46d9-11e1-99f4-0024e8c61285";
		
		//this uuid belongs to a TestPanel instance that does not have any references linking to it, so it can be purged without problems
		String uuidTemp = "05df4577-46d9-11e1-99f4-0024e8c61285";
		
		LabTestPanel labTestPanel = Context.getService(LabCatalogService.class).getLabTestPanelByUuid(uuidTemp);
		try {
