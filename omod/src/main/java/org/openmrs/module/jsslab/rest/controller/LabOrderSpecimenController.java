...
import org.openmrs.module.jsslab.rest.resource.LabOrderSpecimenResource;
...
public class LabOrderSpecimenController extends BaseCrudController<LabOrderSpecimenResource> {

	private static final Log log = LogFactory.getLog(LabOrderSpecimenController.class);
	
	@Override
	public LabOrderSpecimenResource getResource() {
		log.info("getting LabOrderSpecimen resource");
		return Context.getService(RestService.class).getResource(LabOrderSpecimenResource.class);
	}
