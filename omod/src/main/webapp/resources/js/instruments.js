jQuery(document).ready(function() {
	...
	//			}
			...
			if (btnId.startsWith("radioBtnSelectInstrument_")) {
				...
				if (jsslab.isValidUuid(itemUuid) && jQuery('#buttonAddNewInstrument').attr('disabled') == true) {
				...
				if (jsslab.isValidUuid(itemUuid) && jQuery('#buttonAddNewSupplyItem').attr('disabled') == true) {
...
//		if (!shouldContinue) return;
		...
		if (jsslab.isValidUuid(jsslab.instrumentsPage.getSelectedInstrumentUuid())) {
...
//		if (!shouldContinue) return;
		...
		if (jsslab.isValidUuid(getSelectedSupplyItemUuid())) {
